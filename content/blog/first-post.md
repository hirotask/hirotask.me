...
I usually write blog posts in Japanese on [Qiita](https://qiita.com/hirotask). This is a great platform, but I was a bit worried about things like the risk of the site being unavailable due to cloud outages, and its long-term sustainability.
In fact, I used to use a site called <https://bento.me> as a link hub, but that service suddenly shut down as well. SaaS services eventually come to an end ;(

So I decided to spend some time rebuilding my own website and added a blog section to it!
